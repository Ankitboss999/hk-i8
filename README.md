...
```
bash <(curl -s https://raw.githubusercontent.com/gamerzhacker1/hk-i8/main/install.sh)
  ```
```
bash <(wget -qO- https://raw.githubusercontent.com/gamerzhacker1/hk-i8/main/install.sh)
 ```
